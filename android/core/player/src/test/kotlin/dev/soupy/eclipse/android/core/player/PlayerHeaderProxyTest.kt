...
class PlayerHeaderProxyTest {
    ...
    fun proxyForwardsIncomingAndSessionHeaders() {
        FakeUpstreamServer(
            ...
            val proxied = PlayerHeaderProxy.proxiedUrl(
            ...
            connection.setRequestProperty("User-Agent", "MPV-test")
            ...
            assertTrue("user-agent: mpv-test" in request)
    ...
    private class FakeUpstreamServer(
        ...
        private val worker = thread(name = "fake-player-upstream", isDaemon = true) {
